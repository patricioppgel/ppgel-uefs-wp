	...
	*/
	function enqueue_feedback_scripts() {
		...
		if ( isset( $screen ) && $screen->id == 'plugins' ) {
			...
			wp_enqueue_style( 'cool-plugins-feedback-css', $this->plugin_url . 'feedback/css/admin-feedback.css', null, $this->plugin_version );
		}
	}
	...
	public function show_deactivate_feedback_popup() {
		...
		<div id="cool-plugins-feedback-<?php echo esc_attr($this->plugin_slug);?>" class="hide-feedback-popup">
			...
			<div class="cp-feedback-loader">
				<img src="<?php echo esc_url($this->plugin_url); ?>feedback/images/cool-plugins-preloader.gif">
			</div>
