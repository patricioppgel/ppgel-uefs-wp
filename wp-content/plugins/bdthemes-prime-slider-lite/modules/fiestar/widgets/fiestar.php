...
class Fiestar extends Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        $this->add_control( 'show_navigation_arrows', [
            'label'     => esc_html__( 'Show Arrows', 'bdthemes-prime-slider' ) . BDTPS_NC,
            'type'      => Controls_Manager::SWITCHER,
            'default'   => 'yes',
            'separator' => 'before',
        ] );
        ...
        $this->add_group_control( Group_Control_Text_Stroke::get_type(), [
            ...
            'label'    => __( 'Text Stroke', 'bdthemes-prime-slider' ) . BDTPS_NC,
            'selector' => '{{WRAPPER}} .bdt-fiestar-slider .bdt-title a',
        ] );
        $this->end_controls_section();
        ...
        $this->add_control( 'nav_arrows_icon', [
    ...
    public function render_footer()
    {
        ...
        if ( $settings['show_navigation_arrows'] ) {
            ...
            echo  esc_attr( $settings['nav_arrows_icon'] ) ;
            ?>"></i>
                        </div>
